...
# Path is relative to .cargo/ — vcpkg lives at ffs/vcpkg/ under the project root.
...
[env]
VCPKG_ROOT = { value = "../ffs/vcpkg", relative = true }
"@ | Set-Content -Path $ffsToml

Write-Host "Wrote .cargo/ffs.toml (VCPKG_ROOT=ffs/vcpkg)"
