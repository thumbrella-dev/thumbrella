...
pub fn format_manifest() -> &'static [FormatEntry] {
    &[
        ...
        FormatEntry {
            extension: "m2ts",
            label: "Blu-ray Transport Stream",
            kind: FileKind::Video,
            tier: 2,
            renderer: "libav",
            shortcut: false,
        ...
        FormatEntry {
            extension: "vtu",
            label: "VTK XML UnstructuredGrid",
            kind: FileKind::Geometry,
            tier: 3,
            renderer: "f3d",
            shortcut: false,
